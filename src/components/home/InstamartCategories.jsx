  ...
  const categorySections = [
    {
      ...
      items: [
        ...
        { id: "fresh-dairy", subId: "butter-cheese", name: "Cheese & Spreads", imageUrl: "https://images.unsplash.com/photo-1624806992066-5ffcf7ca186b?auto=format&fit=crop&w=400&q=80", bgTint: "bg-[#FFFBEB] border-[#FEF3C7]" }
      ]
    },
    {
      title: "Grocery & Kitchen",
      items: [
        { id: "staples", subId: "atta-flour", name: "Atta, Rice and Dal", imageUrl: "https://images.unsplash.com/photo-1586201375761-83865001e31c?auto=format&fit=crop&w=400&q=80", bgTint: "bg-[#FEFCE8] border-[#FEF08A]" },
        { id: "food", subId: "masala-spices", name: "Masalas & Spices", imageUrl: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&w=400&q=80", bgTint: "bg-[#FFF1F2] border-[#FFE4E6]" },
    ...
    },
    {
      ...
      items: [
        ...
        { id: "food", subId: "snacks-namkeen", name: "Chips and Namkeens", imageUrl: "https://images.unsplash.com/photo-1566478989037-eec170784d0b?auto=format&fit=crop&w=400&q=80", bgTint: "bg-[#FEFCE8] border-[#FEF08A]" },
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-4 sm:py-6 space-y-6">
      ...
      {categorySections.map((section, idx) => (
        <div key={idx} className="bg-white rounded-3xl p-4 sm:p-5 border border-[#E2E2E7] shadow-2xs">
          ...
          {/* 4-Column Category Cards Grid with Rounded Corners and Uniform Sizing */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3.5">
            {section.items.map((item, itemIdx) => (
              ...
              >
                ...
                <div className={`w-full aspect-[4/3] rounded-2xl ${item.bgTint} border p-1.5 flex items-center justify-center overflow-hidden mb-1.5 shadow-2xs group-hover:scale-[1.02] transition-transform`}>
                  <img
                    src={item.imageUrl}
                    alt={item.name}
                    loading="lazy"
